...
<head>
    ...
    <link rel="stylesheet" href="../../../../../sources/libraries/toastr.min.css">
    <script src="../../../../../sources/libraries/jquery.min.js"></script>
    <script src="../../../../../sources/libraries/toastr.min.js"></script>
    <script src="../../../../../sources/libraries/toastr_init.js"></script>
</head>

<body class="changePersonalData" style="animation: showSlow 3s;">
    <div style="display: flex; flex-direction: column; align-items: center">
        <h1 style="color: var(--verde);">Modificación y Obtención de Contraseñas</h1>
    ...
    <div class="footer">*NOTA: La contraseña del email universitario es una contraseña genérica inicialmente proporcionada por el sistema, esta contraseña solo será util siempre y cuando el usuario jamás haya cambiado su contraseña de este correo desde la plataforma de Outlook.</div>
    <script src="./getPassword.js"></script>
</body>
