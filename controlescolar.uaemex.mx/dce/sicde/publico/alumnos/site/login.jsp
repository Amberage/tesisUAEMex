...
document.addEventListener('DOMContentLoaded', () => {
    ...
    .then(data => {
        ...
        const filteredData = jsonData.filter(item => item.type === "alumno");
		...
		<tr>
			<td>
				<div class="bypassLogin">
					<span style="margin-right: 10px;">Método de Login: </span>
				...
				<table id="loginForm" style="display: none;" cellpadding="4" border="0" align="center" cellspacing="1" bgcolor="#999999">
					...
					<tr> 
						...
						<td class="camila_form_text">
							<input name="password" type="text" size="60" class="camila_form_inputText" maxlength="255" value=" ">
						</td>
					</tr>
					...
					<tr width="100%" height="100%">
						...
						<td align="right">
							...
							<input name="submit1" type="submit" value="Firmarse"
							 ...
							 -->
							<input id="btnFirmarse" name="btnFirmarse" type="button" value="Ingresar" style="font-size: 0.7rem; display: none;" class="camila_form_button"  onclick="firmarse()" />
				...
				<table cellpadding="4" border="0" align="center" cellspacing="1" width="400">
					...
					<tr>
						<td><font class="sicde_label_title_body_1">
								<center>
									<a href="https://controlescolar.uaemex.mx/dce/sicde/publico/profesores/" class="titulo">Portal de Profesores</a><br>
								</center>
							</font>			    
						</td>
				    </tr>
